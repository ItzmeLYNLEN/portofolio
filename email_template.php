                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width: 100%; padding-right: 0px; padding-left: 0px">
                                                                <div align="center" class="alignment" style="line-height: 10px">
                                                                    <img src="https://i.ibb.co/5BmZnSJ/PHP-logo-svg.png" style="display: block; height: auto; border: 0; width: 150px; max-width: 100%" width="150" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad">
                                                                <div align="center" class="alignment">
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt" width="100%">
                                                                        <tr>
                                                                            <td class="divider_inner" style="font-size: 1px; line-height: 1px; border-top: 1px solid #cdcdcd"><span> </span></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width: 100%; text-align: center">
                                                                <h2 style="
                                                                            ...
                                                                            margin-bottom: 0;
                                                                        ">
                                                                    <span class="tinyMce-placeholder">Pesan Masuk</span>
                                                                </h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="
                                                                        ...
                                                                        ">
                                                                    <p style="margin: 0; margin-bottom: 16px">Anda mendapatkan pesan baru dari <?= $name ?> (<?= $email ?>).</p>
                                                                    <p style="margin: 0">
                                                                        <u><strong>Pesan :<br /></strong></u><?= $message ?>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
